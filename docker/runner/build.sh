...
sudo docker build --network host -t forthy42/net2o:latest .
sudo docker build --network host -f Dockerfile.gui -t forthy42/net2o-gui:latest .
sudo docker build --network host -f Dockerfile.gui+fonts -t forthy42/net2o-gui-fonts:latest .
if [ "$1" != "nopush" ]
then
