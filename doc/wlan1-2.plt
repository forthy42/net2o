...
plot \
 "ef2012/wlan1/timing2" using 1:5 title "Rate" lc rgbcolor "cyan",\
 "ef2012/wlan1/timing2" using 1:4 title "Requested" lc rgbcolor "blue",\
 "ef2012/wlan1/timing2" using 1:3 axis x1y2 title "Slack" lc rgbcolor "red"
