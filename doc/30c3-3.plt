...
set title "WLAN (+VDSL 50), 1 connection" textcolor rgbcolor "green"
...
plot \
 "30c3/wlan-1.tmg" using 1:4 title "Requested" lc rgbcolor "blue",\
 "30c3/wlan-1.tmg" using 1:5 title "Rate" lc rgbcolor "cyan",\
 "30c3/wlan-1.tmg" using 1:3 axis x1y2 title "Slack" lc rgbcolor "red"
